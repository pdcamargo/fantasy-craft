type SavingThrowRowBoxSvg = React.SVGProps<SVGSVGElement>;

export const SavingThrowRowBoxSvg = (props: SavingThrowRowBoxSvg) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 116.1 34" {...props}>
